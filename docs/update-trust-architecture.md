...
- [Desktop stack verification plan](desktop-stack-verification-plan.md) (VP-001) — the platform-signature and role-metadata evidence recorded as two distinct rows ([Platform signing and notarization](#platform-signing-and-notarization) ("two distinct rows")), and the offline platform-revocation `uncertain` outcome ([Platform signing and notarization](#platform-signing-and-notarization) ("being skipped or assumed passing")), this document's own signal mapping states; drafted, acceptance pending.
