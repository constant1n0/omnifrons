...
- [Desktop stack verification plan](desktop-stack-verification-plan.md) (VP-001) — the platform-signature and role-metadata evidence recorded as two distinct rows (:176), and the offline platform-revocation `uncertain` outcome (:174), this document's own signal mapping states; drafted, acceptance pending.
