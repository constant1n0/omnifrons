...
| UTA-001 | Update trust architecture | Keys, metadata, freshness, anti-rollback, compromise recovery; trust roots and online roles, release metadata, freshness, anti-rollback, and compromise recovery are drafted in [update-trust-architecture](update-trust-architecture.md) |
