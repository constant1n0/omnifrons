...
- [ ] 4.2 **Depends on 4.1.** Trigger the authorized run on `ubuntu-24.04` with `vp001_scenario: true`; capture the retained artifact, its SHA-256 digest, Slice 1's recorded baseline facts, and both transcripts.
