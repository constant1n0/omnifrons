...
7. [ADR index and convention](adr/README.md) — decision status and governance.
8. [Product naming and trademark clearance](product-naming.md) — selected name and remaining clearance work.
